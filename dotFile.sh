#!/bin/bash
sudo apt update -y && sudo apt upgrade -y && sudo apt install i3-wm polybar neovim firefox  brightnessctl git -y

cat > /home/macedo/.config/i3/configT.txt << EOF 
...
git clone https://github.com/adi1090x/polybar-themes.git && cd polybar-themes && chmod +x setup.sh

cat > /home/macedo/.config/nvim/init.vim << EOF
" Global Sets """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
