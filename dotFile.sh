...
sudo apt update -y && sudo apt upgrade -y && sudo apt install i3-wm polybar neovim  brightnessctl git alacritty picom snap wget zsh rofi flameshot build-essential nodejs binutils openjdk-21-jdk openjdk-21-jre -y && clear
